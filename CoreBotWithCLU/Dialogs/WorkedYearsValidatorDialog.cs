...
{
  public class WorkedYearsValidatorDialog : CancelAndHelpDialog
  {
    ...
    public WorkedYearsValidatorDialog(HumanResourceRecognizer cluRecognizer)
        : base(nameof(WorkedYearsValidatorDialog))
    {
